...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230316050121-cb9829733364
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230316041505-b7cb7b85d707 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230316050121-cb9829733364
