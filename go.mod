...
require (
	...
	k8s.io/api v0.0.0-20200425115949-d6381a80f2a6
	k8s.io/apimachinery v0.0.0-20200423195709-147f4cafe1e5
	k8s.io/apiserver v0.0.0-20200425080611-eb052253d336
...
replace (
	...
	k8s.io/api => k8s.io/api v0.0.0-20200425115949-d6381a80f2a6
	k8s.io/apimachinery => k8s.io/apimachinery v0.0.0-20200423195709-147f4cafe1e5
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20200425080611-eb052253d336
