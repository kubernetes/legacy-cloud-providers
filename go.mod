...
require (
	...
	k8s.io/cloud-provider v0.0.0-20231010195057-3d9f504cb47c
...
require (
	...
	k8s.io/component-helpers v0.0.0-20231010192113-aea163aecbf2 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20231010195057-3d9f504cb47c
