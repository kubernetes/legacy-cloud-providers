...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230413233339-ddae6b176c3b
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230413220824-d4bb62a6836a // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230413233339-ddae6b176c3b
