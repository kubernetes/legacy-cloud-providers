...
require (
	...
	k8s.io/cloud-provider v0.0.0-20240110195054-2574c00c5eda
...
require (
	...
	k8s.io/component-helpers v0.0.0-20240110181334-5a7ccf580ca9 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20240110195054-2574c00c5eda
