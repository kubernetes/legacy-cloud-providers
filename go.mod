...
require (
	...
	k8s.io/cloud-provider v0.0.0-20211108094533-654dbccdb44f
	k8s.io/component-base v0.0.0-20211104205040-9025b85fb213
	k8s.io/csi-translation-lib v0.0.0-20211104011233-ffd4cd090044
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20211108094533-654dbccdb44f
	k8s.io/component-base => k8s.io/component-base v0.0.0-20211104205040-9025b85fb213
	k8s.io/controller-manager => k8s.io/controller-manager v0.0.0-20211108094305-b07e106819b3
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.0.0-20211104011233-ffd4cd090044
