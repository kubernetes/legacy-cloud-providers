...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230515180053-d0018cb2383b
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230515171335-c070cc577fc4 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230515180053-d0018cb2383b
