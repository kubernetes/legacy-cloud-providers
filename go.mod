...
require (
	...
	k8s.io/cloud-provider v0.0.0-20240307222106-b9ae6ea011e2
...
require (
	...
	k8s.io/component-helpers v0.0.0-20240307191728-578b3ad75765 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20240307222106-b9ae6ea011e2
