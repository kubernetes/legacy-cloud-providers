...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230503204916-54d694f84a79
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230503184823-e13365989545 // indirect
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20230504073154-e15c59590bea
	k8s.io/client-go => k8s.io/client-go v0.0.0-20230503180228-383ccb06d023
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230503204916-54d694f84a79
