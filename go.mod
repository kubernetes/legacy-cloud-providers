...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230718024642-65913cfe152f
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230718021330-c2a2c968b338 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230718024642-65913cfe152f
