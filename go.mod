...
require (
	...
	k8s.io/cloud-provider v0.0.0-20231220185104-30270693811f
...
require (
	...
	k8s.io/component-helpers v0.0.0-20231220174623-c3fe7bbf6991 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20231220185104-30270693811f
