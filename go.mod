...
require (
	...
	k8s.io/mount-utils v0.0.0-20230907051701-23ab969dca0f
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20230918111533-0b1bd091307c
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.0.0-20230907051701-23ab969dca0f
)
