...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230602185042-d8436505226d
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230602182806-d838a2ab9063 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230602185042-d8436505226d
