...
require (
	...
	k8s.io/cloud-provider v0.0.0-20220224224938-d577f3510f33
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20220224224938-d577f3510f33
	k8s.io/component-base => k8s.io/component-base v0.0.0-20220224221742-bc1ca3c569ce
	k8s.io/controller-manager => k8s.io/controller-manager v0.0.0-20220224224753-614f5732bb96
