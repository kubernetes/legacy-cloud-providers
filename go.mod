...
require (
	...
	k8s.io/client-go v0.0.0-20200221045642-7f576abe0ebe
	k8s.io/cloud-provider v0.0.0-20200201000119-7b8ede55b43a
	k8s.io/csi-translation-lib v0.0.0-20200201000253-f077c5e42bdf
	k8s.io/klog v0.3.1
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.0.0-20200221045642-7f576abe0ebe
