...
require (
	...
	k8s.io/apiserver v0.0.0-20210612020006-ed00fbe36bd9
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20210612020006-ed00fbe36bd9
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.0.0-20210614230117-b6d4300ffbf5
