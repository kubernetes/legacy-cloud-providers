...
require (
	...
	k8s.io/cloud-provider v0.0.0-20231101145313-c71866166519
...
require (
	...
	k8s.io/component-helpers v0.0.0-20231101135125-a510ccaf06ea // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20231101145313-c71866166519
