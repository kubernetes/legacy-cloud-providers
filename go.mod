...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230915230954-73ce03d745d1
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230915223547-16b62d9d7801 // indirect
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20230919143320-696768606f54
	k8s.io/client-go => k8s.io/client-go v0.0.0-20230918103813-b5b93323304e
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230915230954-73ce03d745d1
