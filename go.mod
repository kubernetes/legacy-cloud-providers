...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230515180054-fc3a3c565630
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230515171336-46310a3188cf // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230515180054-fc3a3c565630
