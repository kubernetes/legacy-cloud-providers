...
require (
	...
	k8s.io/cloud-provider v0.0.0-20231012135716-d6f7d275faa8
...
require (
	...
	k8s.io/component-helpers v0.0.0-20231012121233-6337affed2cc // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20231012135716-d6f7d275faa8
