...
require (
	...
	k8s.io/apiserver v0.0.0-20191205215113-79486f17960a
	...
	k8s.io/csi-translation-lib v0.0.0-20191121022617-4b18d293964d
	k8s.io/klog v1.0.0
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20191205215113-79486f17960a
