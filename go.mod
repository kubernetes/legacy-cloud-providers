...
require (
	...
	k8s.io/cloud-provider v0.0.0-20230325031916-fe18149bc97c
...
require (
	...
	k8s.io/component-helpers v0.0.0-20230325023700-0181d85c8099 // indirect
...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20230325031916-fe18149bc97c
